...
## Installation
### Configuration
Testé sur Ubuntu 15.10 et les versions antérieures, **si vous n'êtes pas en ethernet, vous devrez avoir deux cartes wifi (soit wlan0 et wlan1, généralement) dont une qui accepte le mode moniteur.**
